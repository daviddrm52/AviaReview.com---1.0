...
<html lang="es">
    ...
    <main class="my-3">
    <div class="container mt-3 rounded-3" style="background-color: #EBEBEB;">
            <div class="row">
                ...
                <div class="col-lg-6 order-1">
                    <div class="row m-3">
                        <div class="col">
                            <?php if($resena):?>
                            <p class="fs-2 mt-3 text-center">Reseña de <?php echo htmlspecialchars($nombreAerolinea['nombre_aerolinea']) ?> a <?php echo htmlspecialchars($aeropuertoDestino['nombre_aeropuerto']) ?></p>
                            <ul>
                            ...
                            <ul>
                                ...
                                <li class="enlaces-paginas"> <a href="/aviareview/html/aerolineas/detalles-aerolinea.php?id=<?php echo $nombreAerolinea['id'] ?>"><?php echo htmlspecialchars($nombreAerolinea['nombre_aerolinea']) ?></a> </li>
                            </ul>
                            <ul>
                                <li> <b>Aeropuerto de origen</b> </li>
                                <li class="enlaces-paginas"> <a href="/aviareview/html/aeropuertos/detalles-aeropuerto.php?id=<?php echo $aeropuertoOrigen['id'] ?>"><?php echo htmlspecialchars($aeropuertoOrigen['nombre_aeropuerto']) ?></a> </li>
                            </ul>
                            <ul>
                                <li> <b>Aeropuerto de destino</b> </li>
                                <li class="enlaces-paginas"> <a href="/aviareview/html/aeropuertos/detalles-aeropuerto.php?id=<?php echo $aeropuertoDestino['id'] ?>"><?php echo htmlspecialchars($aeropuertoDestino['nombre_aeropuerto']) ?></a> </li>
                            </ul>
                            <ul>
                                <li> <b>Reseña realizada por: </b> </li>
                                <li class="enlaces-paginas"> <a href="/aviareview/html/usuarios/detalles-externos-usuario.php?id=<?php echo $nombreUsuario['id'] ?>"><?php echo htmlspecialchars($nombreUsuario['nombre_usuario']) ?> </a> </li>
                            </ul>
                            <ul>
